...
registerPortedMageTests({
  "sourcePath": "scripts/cards/conditional/ConditionalAsThoughTest.java",
  "tests": [
    {
      "name": "test_PlayFromNotOwnHandZoneAllEffect",
      "operations": [
        {
          "op": "clearZone",
          "player": 0,
    ...
    {
      "name": "test_TargetCardInLibrary_CantUseAsAbilityTarget",
      "operations": []
    },
    {
