...
pub(super) fn looked_battlefield_cards_compact_optional_selection_wrappers() {
    ...
    let aethermage_rendered = crate::runtime_display::compiled_text_lines(&aethermage)
        .join(" ")
        .to_ascii_lowercase();
    ...
    let ajani_rendered = crate::runtime_display::compiled_text_lines(&ajani)
        .join(" ")
        .to_ascii_lowercase();
    ...
    let knickknack_rendered = crate::runtime_display::compiled_text_lines(&knickknack)
        .join(" ")
        .to_ascii_lowercase();
...
pub(super) fn valley_floodcaller_compiled_lines_meet_strict_semantic_threshold() {
    ...
    let compiled = crate::runtime_display::unprocessed_compiled_lines(&def);
...
pub(super) fn parse_sarevok_deathbringer_keeps_global_ltb_gate_and_player_loss() {
    ...
    let compiled = crate::runtime_display::canonical_compiled_lines(&def).join(" ");
    assert!(
