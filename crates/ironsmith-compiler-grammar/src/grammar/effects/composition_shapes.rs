...
#[path = "composition_shapes/voting.rs"]
mod voting;
pub use voting::*;

#[path = "composition_shapes/choice_complements.rs"]
mod choice_complements;
#[path = "composition_shapes/semantic_sequences.rs"]
mod semantic_sequences;
#[path = "composition_shapes/triggering_spell_damage.rs"]
...
#[cfg(test)]
#[path = "composition_shapes/tests.rs"]
mod tests;
