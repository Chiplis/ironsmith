...
/// Render the canonical oracle surface used for storage and exports.
///
...
mod tests {
    ...
    #[test]
    fn canonical_compiled_lines_strip_reminder_text() {
    ...
    #[test]
    fn canonical_compiled_lines_do_not_depend_on_compiled_ast() {
