...
pub use lexer::{
    ...
    contains_token_word_sequence, find_token_any_word, find_token_kind, find_token_word,
    find_token_word_sequence, lex_line, parser_token_word_positions, parser_token_word_refs,
    render_token_slice, rfind_token_word, split_lexed_sentences, token_word_pieces_for_token,
    token_word_refs, trim_lexed_commas, word_slice_contains_all_words,
    word_slice_contains_any_phrase, word_slice_contains_any_phrase_or_empty,
    word_slice_contains_any_word, word_slice_contains_phrase, word_slice_contains_phrase_or_empty,
    ...
    word_slice_find_any_phrase_start_or_zero, word_slice_find_any_word,
    word_slice_find_phrase_start, word_slice_find_phrase_start_or_zero, word_slice_find_window_by,
    word_slice_find_word, word_slice_find_word_where, word_slice_rfind_word_where,
    word_slice_starts_with, word_slice_starts_with_any, word_slice_strip_any_prefix,
    word_slice_strip_any_suffix, word_slice_strip_prefix, word_slice_strip_suffix,
};
