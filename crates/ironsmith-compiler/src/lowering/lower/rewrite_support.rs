...
fn reconcile_alternative_cast_condition_references(builder: &mut CardDefinitionBuilder) {
    ...
    fn rewrite_condition(
        ...
        match condition {
            ...
            crate::effect::Condition::Not(inner) => {
                rewrite_condition(inner, method_name, mana_cost, allow_that)
    ...
    fn rewrite_effect(
        ...
        if let Some(conditional) = effect.downcast_ref::<crate::effects::ConditionalEffect>() {
            ...
            let condition =
                rewrite_condition(&conditional.condition, method_name, mana_cost, allow_that);
    ...
    for segment in &mut program.segments {
        ...
        segment.default_effects = segment
            ...
            .iter()
            .map(|effect| {
                let (effect, matched) = rewrite_effect(
                    effect,
                    method_name,
                    mana_cost,
