...
pub use front_end::{
    ...
    word_slice_ends_with, word_slice_find_any_phrase_span, word_slice_find_any_word,
    word_slice_find_phrase_start, word_slice_find_phrase_start_or_zero,
    word_slice_find_phrase_value, word_slice_find_word, word_slice_find_word_where,
    word_slice_matching_phrase, word_slice_matching_value, word_slice_rfind_word_where,
    word_slice_starts_with, word_slice_starts_with_any, word_slice_strip_first_word_value,
    word_slice_strip_prefix_value, word_slice_strip_suffix_value, word_view_has_any_prefix,
