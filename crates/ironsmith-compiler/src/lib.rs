...
pub use front_end::{
    ...
    UnsupportedLineCst, clone_sentence_chunk_tokens, contains_sequence, contains_window,
    extract_parenthetical_sentences, find_any_str_index, find_index, find_str_by, find_str_index,
    ...
    rewrite_followup_intro_to_if_lexed, rfind_index, rfind_str_by, slice_contains,
    slice_contains_all, slice_contains_any, slice_contains_str, slice_ends_with, slice_eq_any,
