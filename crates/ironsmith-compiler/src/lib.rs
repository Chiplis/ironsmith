...
pub use front_end::{
    ...
    contains_token_word_sequence, contains_window, extract_parenthetical_sentences, find_index,
    find_token_any_word, find_token_word, find_token_word_sequence, find_window_by,
    find_window_index, is_at_trigger_intro_lexed, iter_contains, lex_line, lexed_head_words,
    ...
    render_token_slice, rewrite_followup_intro_to_if_lexed, rfind_index, rfind_token_word,
    ...
    split_text_for_parse, split_text_for_parse_with_restrictions, str_contains, str_contains_char,
    str_ends_with, str_ends_with_char, str_find, str_find_char, str_split_once,
    ...
    word_slice_ends_with, word_slice_find_any_word, word_slice_find_phrase_start,
