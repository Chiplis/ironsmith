...
use crate::runtime_backend::grammar::{filters, leaf, primitives};
use crate::runtime_backend::lexer::{OwnedLexToken, TokenWordView, trim_lexed_commas};
...
pub(crate) fn parse_carryable_subject_tokens(
    ...
    if crate::runtime_backend::util::is_source_reference_words(
