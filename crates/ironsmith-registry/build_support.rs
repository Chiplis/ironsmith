...
fn workspace_root(manifest_dir: &str) -> PathBuf {
    Path::new(manifest_dir)
        ...
        .unwrap_or_else(|| panic!("failed to determine workspace root from {}", manifest_dir))
        .to_path_buf()
}
...
pub fn run_runtime_registry_build() {
...
"#;
    ...
    let status = Command::new(python)
        ...
        .arg(workspace_root.join("scripts/generate_baked_registry.py"))
        .arg("--db-path")
