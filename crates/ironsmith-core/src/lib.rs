...
pub use effect::{
    ...
    ReplacementApplyMode, RestartGameEffect, RestrictionStart, RetainManaUntilEndOfTurnEffect,
    RetargetMode, RetargetStackObjectEffect, ReturnAllToBattlefieldEffect, ReturnAsAuraOptions,
