...
impl CardDefinitionBuilder {
    ...
    fn parse_text_with_annotations_cached(
        ...
        let compiled = compiler::CardTextCompiler::compile(
            self,
            text,
            compiler::CompilePolicy { allow_unsupported },
        )?;
        Ok((compiled.definition, compiled.annotations))
    }
...
If a card would be put into your graveyard from anywhere this turn, exile that card instead.";
    ...
    fn parser_sentence_helpers_do_not_use_retired_fixed_helper_tags() {
        for source in [
            include_str!("builders/compiler/sentences/effect_sentences/dispatch_entry.rs"),
            include_str!("builders/compiler/sentences/effect_sentences/dispatch_inner/mod.rs"),
            include_str!(
            ...
            include_str!(
                "builders/compiler/sentences/effect_sentences/dispatch_inner/replacement_and_prevention_shapes.rs"
            ),
            include_str!(
                "builders/compiler/sentences/effect_sentences/dispatch_inner/unsupported_shape_diagnostics.rs"
            ),
            include_str!("builders/compiler/sentences/effect_sentences/search_library.rs"),
            include_str!("builders/compiler/sentences/effect_sentences/sentence_primitives/mod.rs"),
            include_str!(
            ...
            include_str!(
                "builders/compiler/sentences/effect_sentences/sentence_primitives/token_copy_control_family.rs"
            ),
            include_str!(
                "builders/compiler/sentences/effect_sentences/sentence_primitives/combat_and_damage_family.rs"
            ),
            include_str!(
                "builders/compiler/sentences/effect_sentences/sentence_primitives/delayed_step_family.rs"
            ),
            include_str!(
                "builders/compiler/sentences/effect_sentences/sentence_primitives/mechanic_marker_family.rs"
            ),
        ] {
            for retired_tag in [
                "\"exiled_0\"",
