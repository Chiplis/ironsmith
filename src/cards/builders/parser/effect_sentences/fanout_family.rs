...
use crate::cards::builders::{
    CardTextError, EffectAst, ExtraTurnAnchorAst, PlayerAst, TagKey, TargetAst, Verb, IT_TAG,
};
...
pub(crate) fn parse_same_name_target_fanout_sentence(
        ...
        && let Some(first_filter) = target_object_filter_mut(&mut first_target)
    {
        ...
        if first_filter.owner.is_none() {
            ...
            if first_filter.owner.is_none() && contains_word_window(&words_all, &["your", "graveyard"])
            {
