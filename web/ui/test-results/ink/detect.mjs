...
const fullScan=await scan('/test-results/ink/arnjlot.jpg');const style={'--printed-layout':JSON.stringify({title:{x:34,y:26,width:402,height:29},type:{x:53,y:380,width:381,height:33},rules:{x:53,y:413,width:381,height:196}})};
document.body.innerHTML='';const original=new Image();original.src='/test-results/ink/arnjlot.jpg';document.body.append(original);
